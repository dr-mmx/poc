...
func (m *AppRegistry) GetAppId() string {
	if m != nil {
		return m.AppId
	}
	return ""
...
var fileDescriptor_7d3ebab127a5ad8e = []byte{
	...
	0x85, 0x04, 0xa3, 0x02, 0xa3, 0x06, 0x67, 0x10, 0x84, 0x03, 0x12, 0x4d, 0x2c, 0x28, 0xf0, 0x4c,
	0x91, 0x60, 0x82, 0x88, 0x82, 0x39, 0x20, 0xd1, 0x94, 0xd4, 0x32, 0xcf, 0x14, 0x09, 0x66, 0x88,
	...
	0x00, 0x00, 0xff, 0xff, 0xc2, 0x72, 0x57, 0x25, 0xe0, 0x00, 0x00, 0x00,
}
...
func (m *AppRegistry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AppId) > 0 {
		i -= len(m.AppId)
		copy(dAtA[i:], m.AppId)
		i = encodeVarintAppRegistry(dAtA, i, uint64(len(m.AppId)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Index) > 0 {
